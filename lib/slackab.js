    ...
    return {
      post: function (cb, errcb) {
        ...
        if(event == 'merge_request'){
          body.project_id = body.object_attributes.source_project_id;
          body.target_id  = body.object_attributes.iid;
          body.target     = "merge_requests"
        } else if(event == 'issue'){
          body.project_id = body.object_attributes.project_id;
          body.target_id  = body.object_attributes.iid;
          body.target     = "issues"
        }else{
          body.target_id = 0;
        ...
        request.get(options, function (err, response, project) {
          ...
          if (!err && response.statusCode == 200) {
            body.project_url  = project.web_url;
          ...
          try {
            ...
            body.event_url = body.project_url + '/' + body.target + '/' +  body.target_id;
          } catch(e) {
